...
Revision ID: 76a1761ede83
Revises: 
Create Date: 2021-04-05 04:58:49.741581
...
goals = ["travel", "study", "work", "relocate", "programming", "exam"]

# revision identifiers, used by Alembic.
revision = '76a1761ede83'
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    teachers_table = op.create_table('teachers',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(), nullable=False),
    ...
    teachers_goals_table = op.create_table('teachers_goals',
    sa.Column('teacher_id', sa.Integer(), nullable=True),
    ...
    op.bulk_insert(
        teachers_table,
        [
            {"name": teachersData[0]["name"], "about": teachersData[0]["about"], "rating": teachersData[0]["rating"],
             "price": teachersData[0]["price"], "schedule": json.dumps(teachersData[0]["free"])},
            {"name": teachersData[1]["name"], "about": teachersData[1]["about"], "rating": teachersData[1]["rating"],
             "price": teachersData[1]["price"], "schedule": json.dumps(teachersData[1]["free"])},
            {"name": teachersData[2]["name"], "about": teachersData[2]["about"], "rating": teachersData[2]["rating"],
             "price": teachersData[2]["price"], "schedule": json.dumps(teachersData[2]["free"])},
            {"name": teachersData[3]["name"], "about": teachersData[3]["about"], "rating": teachersData[3]["rating"],
             "price": teachersData[3]["price"], "schedule": json.dumps(teachersData[3]["free"])},
            {"name": teachersData[4]["name"], "about": teachersData[4]["about"], "rating": teachersData[4]["rating"],
             "price": teachersData[4]["price"], "schedule": json.dumps(teachersData[4]["free"])},
            {"name": teachersData[5]["name"], "about": teachersData[5]["about"], "rating": teachersData[5]["rating"],
             "price": teachersData[5]["price"], "schedule": json.dumps(teachersData[5]["free"])},
            {"name": teachersData[6]["name"], "about": teachersData[6]["about"], "rating": teachersData[6]["rating"],
             "price": teachersData[6]["price"], "schedule": json.dumps(teachersData[6]["free"])},
            {"name": teachersData[7]["name"], "about": teachersData[7]["about"], "rating": teachersData[7]["rating"],
             "price": teachersData[7]["price"], "schedule": json.dumps(teachersData[7]["free"])},
            {"name": teachersData[8]["name"], "about": teachersData[8]["about"], "rating": teachersData[8]["rating"],
             "price": teachersData[8]["price"], "schedule": json.dumps(teachersData[8]["free"])},
            {"name": teachersData[9]["name"], "about": teachersData[9]["about"], "rating": teachersData[9]["rating"],
             "price": teachersData[9]["price"], "schedule": json.dumps(teachersData[9]["free"])},
            {"name": teachersData[10]["name"], "about": teachersData[10]["about"], "rating": teachersData[10]["rating"],
             "price": teachersData[10]["price"], "schedule": json.dumps(teachersData[10]["free"])},
            {"name": teachersData[11]["name"], "about": teachersData[11]["about"], "rating": teachersData[11]["rating"],
             "price": teachersData[11]["price"], "schedule": json.dumps(teachersData[11]["free"])},
        ],
    )
    op.bulk_insert(
        goals_table,
    ...
    op.bulk_insert(
        teachers_goals_table,
        [
            {"teacher_id": 1, "goal_id": 1},
            {"teacher_id": 1, "goal_id": 2},
            {"teacher_id": 1, "goal_id": 4},
            {"teacher_id": 2, "goal_id": 2},
            {"teacher_id": 2, "goal_id": 4},
            {"teacher_id": 3, "goal_id": 3},
            {"teacher_id": 4, "goal_id": 1},
            {"teacher_id": 4, "goal_id": 2},
            {"teacher_id": 5, "goal_id": 1},
            {"teacher_id": 6, "goal_id": 1},
            {"teacher_id": 6, "goal_id": 2},
            {"teacher_id": 7, "goal_id": 1},
            {"teacher_id": 7, "goal_id": 2},
            {"teacher_id": 7, "goal_id": 4},
            {"teacher_id": 8, "goal_id": 2},
            {"teacher_id": 9, "goal_id": 3},
            {"teacher_id": 9, "goal_id": 4},
            {"teacher_id": 10, "goal_id": 3},
            {"teacher_id": 11, "goal_id": 1},
            {"teacher_id": 11, "goal_id": 2},
            {"teacher_id": 11, "goal_id": 3},
            {"teacher_id": 12, "goal_id": 1},
            {"teacher_id": 12, "goal_id": 3},
        ]
    )
